...
public class Utils {
  public static class Vector3D {
    ...
    /**
     * Calculates the rotation of this vector about the Z axis, then puts the resulting coordinates
     * into the vectorToPutResultsIn. Calling this method never changes the vector it is called in.
     *
     * @param theta the angle specifying the how much to rotate
     * @param vectorToPutResultsIn the vector which gets the coordinates resulting from the rotation
     *     calculation.
     */
    ...
    /**
     * Adds the specified vector to this one and returns the result in a new Vector.
     *
     * @param b the Vector to subtract from this one
     */
    ...
    /**
     * Adds the specified vector to this one and returns the result in the specified
     * vectorToPutResultsIn
     *
     * @param b the Vector to add to this one
     * @param vectorToPutResultsIn the Vector to put the results in
     */
    ...
    /**
     * Subtracts the specified vector from this one and returns the result in a new Vector.
     *
     * @param b the Vector to subtract from this one
    ...
    /**
     * Subtracts the specified vector from this one and returns the result in the specified
     * vectorToPutResultsIn
     *
     * @param b the Vector to subtract from this one
     * @param vectorToPutResultsIn the Vector to put the results in
    ...
    /**
     * Returns the cross product of the current vector (a) and the specified vector (b). it returns
     * aXb. The vector resulting from the cross product has a direction which is the normal of a and
     * b. The magnitude of the cross product is the area of the parallelogram traced by the two
     * vectors a and b.
     */
    ...
    /**
     * Calculates the cross-product of this vector with the specified one. The result is put into
    ...
    /**
     * Performs a scalar multiplication on this vector and returns the result in a new Vector.
     *
     * @param scalarFactor the scalar factor to multiply each of the vector's components by
     * @return a new Vector with the result of the scalar multiplication inside it.
     */
    ...
    /**
     * Performs a scalar multiplication on this vector and puts the result in a the specified
     * vectorToPutResultsIn.
     *
     * @param scalarFactor the scalar factor to multiply each of the vector's components by
     */
    ...
    /**
     * Calculates the normal from the specified 3 points. The cross product of (a-b) and (c-b) is
     * put into the vectorToPutNormalInto vector.
     *
     * @param a Vector a
     * @param b Vector b, the vertex of the normal
     * @param c Vector c
     * @param vectorToPutNormalInto The vector which the normal calculation will be put into. This
     *     vector will be changed.
     */
    public void calculateNormal(
        Vector3D a, Vector3D b, Vector3D c, Vector3D vectorToPutNormalInto) {
      // B-b-C
      // |
      // a
      // |
     ...
     *
     * @param vectorToCopy the vector whose values will be copied into this one.
     */
  ...
  public static boolean withinRange(
      Translation2d point1, Translation2d point2, Translation2d robotPose) {
