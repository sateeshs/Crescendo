...
public class Climber extends SubsystemBase {
  ...
  private Climber() {
    ...
    talonConfig.Feedback.SensorToMechanismRatio =
        Constants.ClimberConstants.LeftMotor.kGearboxRotationsToMechanismMeters;
    ...
    talonConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold =
        Constants.ClimberConstants.LeftMotor.kMaxExtensionMeters;
    talonConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold = 0;
    talonConfig.CurrentLimits.StatorCurrentLimit =
        Constants.ClimberConstants.kDefaultStatorCurrentLimit;
  ...
  public void setCurrentLimits(double kCurrentLimit) {
    mLeftClimberMotor
        .getConfigurator()
        .apply(talonConfig.CurrentLimits.withStatorCurrentLimit(kCurrentLimit));
    mRightClimberMotor.getConfigurator().apply(talonConfig);
  }
  ...
  public void FrickItWeBall(boolean limitOverride) {
    mLeftClimberMotor
        ...
        .apply(
            talonConfig
                .SoftwareLimitSwitch
                .withReverseSoftLimitEnable(!limitOverride)
                .withForwardSoftLimitEnable(!limitOverride));
    mRightClimberMotor
        .getConfigurator()
        .apply(
            talonConfig
