...
public class Lighting extends SubsystemBase {
  ...
  public void setClimberSupport(int r, int g, int b) {
    mCANdle.setLEDs(
        ...
        b,
        0,
        7 + Lights.strip1Length + Lights.strip2Length + Lights.strip3Length,
        Lights.strip4Length);
  }
  ...
  public void setRightClimber(int r, int g, int b) {
    mCANdle.setLEDs(
        ...
        b,
        0,
        7 + Lights.strip1Length + Lights.strip2Length + Lights.strip3Length + Lights.strip4Length,
        Lights.strip5Length);
  }
  ...
  public void setRightClimberAnimation(Animation animation) {
    animation.setLedOffset(
        8 + Lights.strip1Length + Lights.strip2Length + Lights.strip3Length + Lights.strip4Length);
