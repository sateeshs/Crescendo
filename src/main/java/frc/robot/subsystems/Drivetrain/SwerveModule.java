...
public class SwerveModule {
  ...
  private final com.ctre.phoenix6.mechanisms.swerve.SwerveModule.ClosedLoopOutputType
      m_steerClosedLoopOutput;
  private final com.ctre.phoenix6.mechanisms.swerve.SwerveModule.ClosedLoopOutputType
      m_driveClosedLoopOutput;
          ...
          case Voltage:
            m_steerMotor.setControl(
                m_angleVoltageSetter
                    .withPosition(angleToSetDeg)
                    .withEnableFOC(Constants.SwerveConstants.kEnableTurnFOC));
            break;
      ...
      case OpenLoopVoltage:
        ...
        m_driveMotor.setControl(
            m_voltageOpenLoopSetter
                ...
                .withEnableFOC(Constants.SwerveConstants.kEnableDriveFOC));
        break;
